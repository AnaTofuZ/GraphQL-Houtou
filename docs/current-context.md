...
- current runtime mainline
  - `nested_variable_object`
    - `houtou_runtime_cached_perl` median `18334/s`
    - `houtou_runtime_native_bundle` median `579118/s`
  - `list_of_objects`
    - `houtou_runtime_cached_perl` median `13849/s`
    - `houtou_runtime_native_bundle` median `501920/s`
  - `abstract_with_fragment`
    - `houtou_runtime_cached_perl` median `16434/s`
...
- current native bundle は旧 `compiled_ir` 比で大幅に速い
  - `nested_variable_object`: 約 `10.2x`
  - `list_of_objects`: 約 `8.6x`
  - `abstract_with_fragment`: 約 `14.1x`
