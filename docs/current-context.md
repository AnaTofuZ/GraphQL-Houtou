...
- current runtime mainline
  - `nested_variable_object`
    ...
    - `houtou_runtime_native_bundle` median `572334/s`
  - `list_of_objects`
    - `houtou_runtime_cached_perl` median `13919/s`
    - `houtou_runtime_native_bundle` median `499414/s`
  - `abstract_with_fragment`
    - `houtou_runtime_cached_perl` median `16432/s`
    - `houtou_runtime_native_bundle` median `546766/s`
...
- current native bundle は旧 `compiled_ir` 比で大幅に速い
  - `nested_variable_object`: 約 `10.1x`
