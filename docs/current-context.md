...
`execute_native_program_xs(...)` に直接流す
...
- current runtime mainline
  - `nested_variable_object`
    ...
    - `houtou_runtime_native_bundle` median `579572/s`
  - `list_of_objects`
    - `houtou_runtime_cached_perl` median `13963/s`
    - `houtou_runtime_native_bundle` median `494673/s`
  - `abstract_with_fragment`
    - `houtou_runtime_cached_perl` median `16330/s`
    - `houtou_runtime_native_bundle` median `549707/s`
